...
namespace Game::Lua::CLibraries::Graphics::Classes {
    ...
    struct GLObjectBase {
        static LuaHelper::StackTableReference InitMetatable(
            lua_State* State,
...
LuaHelper::StackTableReference
    Game::Lua::CLibraries::Graphics::Classes::GLObjectBase::InitMetatable(
        lua_State* State,
        const char* MetatableName) {
...
int Game::Lua::CLibraries::Graphics::Classes::GLObjectBase::__gc(
    lua_State* State) {
    return 0;
}
