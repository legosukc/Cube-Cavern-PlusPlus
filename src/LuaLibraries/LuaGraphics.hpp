...
void Game::Lua::CLibraries::Graphics::Init(lua_State* State) {
	...
	SubtableCache.SetKey<lua_Integer>(State, SDL_GL_CONTEXT_PROFILE_CORE, "Core");
	SubtableCache.SetKey<lua_Integer>(State, SDL_GL_CONTEXT_PROFILE_COMPATIBILITY, "Compatability");
	...
	lua_pushinteger(State, static_cast<lua_Integer>(Game::Graphics::OpenGL::Profile));
