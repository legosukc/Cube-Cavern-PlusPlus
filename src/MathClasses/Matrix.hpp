...
namespace {
	...
	struct _MatrixBase_ColumnMembers<2, ColumnType> {
		...
		constexpr _MatrixBase_ColumnMembers(typename ColumnType::ComponentType Value)
			: R0(Value), R1(Value) {}
	...
	struct _MatrixBase : _MatrixBase_ColumnMembers<_ColumnCount, _ColumnType> {
		...
		using _MatrixBase_ColumnMembers<_ColumnCount, _ColumnType>::_MatrixBase_ColumnMembers;
