...
namespace {
	...
	struct _base_vector3 {
		...
		constexpr _base_vector3(ComponentType _X, ComponentType _Y, ComponentType _Z) : X(_X), Y(_Y), Z(_Z) {}
		constexpr explicit _base_vector3(ComponentType Value) : X(Value), Y(Value), Z(Value) {}
		...
		constexpr _DerivedType operator%(const _DerivedType& B) const {
			return _DerivedType(Math::Mod<ComponentType>(this->X, B.X), Math::Mod<ComponentType>(this->Y, B.Y), Math::Mod<ComponentType>(this->Z, B.Z));
		}

		constexpr _DerivedType operator%(ComponentType B) const {
			return _DerivedType(Math::Mod<ComponentType>(this->X, B), Math::Mod<ComponentType>(this->Y, B), Math::Mod<ComponentType>(this->Z, B));
		}
...
struct Math::Vector3 : ::_base_vector3<float, Vector3> {
...
struct Math::IVector3 : ::_base_vector3<Sint32, IVector3> {

	constexpr IVector3() : _base_vector3() {}
	constexpr IVector3(Sint32 _X, Sint32 _Y, Sint32 _Z) : _base_vector3(_X, _Y, _Z) {}
...
constexpr Math::IVector3 operator+(Math::IVector3::ComponentType A, const Math::IVector3& B) {
...
struct Math::UVector3 : ::_base_vector3<Uint32, UVector3> {

	constexpr UVector3() : _base_vector3() {}
	constexpr UVector3(Uint32 _X, Uint32 _Y, Uint32 _Z) : _base_vector3(_X, _Y, _Z) {}
...
constexpr Math::UVector3 operator+(Math::UVector3::ComponentType A, const Math::UVector3& B) {
...
constexpr Math::Vector3::operator Math::IVector3() const {
	return Math::IVector3(
		static_cast<Math::IVector3::ComponentType>(this->X),
...
constexpr Math::Vector3::operator Math::UVector3() const {
	return Math::UVector3(
		static_cast<Math::UVector3::ComponentType>(this->X),
...
constexpr Math::IVector3::operator Math::Vector3() const {
	return Math::Vector3(
		static_cast<Math::Vector3::ComponentType>(this->X),
