...
namespace Math::Transform {
    ...
    constexpr Math::Mat4 LookAt(const Math::Vector3& Eye,
    ...
    constexpr Math::Mat4 Perspective(float FOV,
                                     float aspect,
                                     float zNear,
                                     float zFar) {
    ...
    constexpr Math::Mat4 Orthographic(float Left, float Right, float Bottom, float Top) {
        Math::Mat4 Result(1.f);
    ...
    constexpr Math::Mat4 Rotate(const Math::Mat4& Matrix,
                                float Angle,
        ...
        Result[0] = Matrix[0] * Rotate[0].X + Matrix[1] * Rotate[0].Y +
                    Matrix[2] * Rotate[0].Z;
        Result[1] = Matrix[0] * Rotate[1].X + Matrix[1] * Rotate[1].Y +
                    Matrix[2] * Rotate[1].Z;
        Result[2] = Matrix[0] * Rotate[2].X + Matrix[1] * Rotate[2].Y +
                    Matrix[2] * Rotate[2].Z;
        Result[3] = Matrix[3];
        return Result;
    }
