...
namespace {
	...
	static Game::Graphics::Classes::VertexArray* _VertexArray_Create_OpenGL() {
		...
		return reinterpret_cast<Game::Graphics::Classes::VertexArray*>(NewVertexArray);
	}
	...
	static void _VertexArray_CreateBulk_OpenGL(size_t CreateAmount, Game::Graphics::Classes::VertexArray* VertexArrays[]) {
		...
		for (size_t i = 0; i < CreateAmount; ++i) {
			VertexArrays[i] = reinterpret_cast<Game::Graphics::Classes::VertexArray*>(new Game::Graphics::Classes::VertexArray_OpenGL());
	...
	static void _glDeleteVertexArrays_GLes20(GLsizei count, const GLuint* arrays) {
