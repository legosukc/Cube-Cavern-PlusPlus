...
void Game::Lua::CLibraries::Buffer::Buffer::InitMetatable(lua_State* State) {
	...
	BufferMetatable.SetKey(State, Buffer::Write<Int8>,	"Writei8");
	BufferMetatable.SetKey(State, Buffer::Write<Int16>, "Writei16");
	BufferMetatable.SetKey(State, Buffer::Write<Int32>, "Writei32");
	BufferMetatable.SetKey(State, Buffer::Write<Int64>, "Writei64");
	...
	BufferMetatable.SetKey(State, Buffer::Read<Int8>,  "Readi8");
	BufferMetatable.SetKey(State, Buffer::Read<Int16>, "Readi16");
	BufferMetatable.SetKey(State, Buffer::Read<Int32>, "Readi32");
	BufferMetatable.SetKey(State, Buffer::Read<Int64>, "Readi64");
	...
	lua_pushvalue(State, BufferMetatable.TableIndex);
	lua_setfield(State, BufferMetatable.TableIndex, "__index");

	lua_settop(State, BufferMetatable.TableIndex - 1);
}
...
static int Game::Lua::CLibraries::Buffer::Create(lua_State* State) {
	...
	BufferUD = static_cast<Buffer*>(lua_newuserdata(State, sizeof(Buffer)));
