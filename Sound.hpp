...
namespace Game::Sound {
	...
	enum class Init_ErrorCodes : uint8_t {
		Success,
...
public:
	...
	virtual void LoadOGG(const char* OGGPath);
...
void Game::Sound::Buffer::LoadOGG(const char* OGGPath) {

	//Mix_Chunk* Audio = Mix_LoadWAV(OGGPath);
	//this->UploadSoundData(Audio->abuf, Audio->alen, AL_FORMAT_STEREO_FLOAT32);
	//Mix_FreeChunk(Audio);
}
